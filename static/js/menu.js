const MENU_DATA = [
  { id: 'sal1', category: 'salads', name: 'Испанец', description: '200 гр — буженина, говядина варёно-копченая, язык говяжий, болгарский перец, лук, огурцы маринованные, майонез, тертый сыр, оливки', price: 710, badge: null, allergens: [] },
  { id: 'sal2', category: 'salads', name: 'Авокадо', description: '200 гр — тигровые креветки, мякоть авокадо, салат латук, айсберг, майонез, помидоры черри', price: 870, badge: null, allergens: [] },
  { id: 'sal3', category: 'salads', name: 'Останкинский', description: '250 гр — телятина, руккола, бальзамический соус, пармезан, миндаль, лук, помидоры черри', price: 920, badge: null, allergens: [] },
  { id: 'sal4', category: 'salads', name: 'Модный «Цезарь»', description: '330 гр — куриная грудка, пармезан, салат романо, айсберг, яйцо пашот, гренки, помидоры черри, фирменный соус «Цезарь»', price: 810, badge: null, allergens: [] },
  { id: 'sal5', category: 'salads', name: '«Цезарь» с креветками', description: '270 гр — тигровые креветки, пармезан, красная икра, салат романо, гренки, помидоры черри, фирменный соус «Цезарь»', price: 980, badge: null, allergens: [] },
  { id: 'sal6', category: 'salads', name: 'Итальянский', description: '300 гр — говяжья вырезка, болгарский перец, салат латук, руккола, мангольд, красный лук, бальзамический соус, помидоры черри, лепешка', price: 900, badge: null, allergens: [] },
  { id: 'sal7', category: 'salads', name: 'Малибу', description: '220 гр — слабосоленая семга, авокадо, огурцы свежие, салат латук, майонез с добавлением соуса «Табаско»', price: 780, badge: null, allergens: [] },
  { id: 'sal8', category: 'salads', name: 'Оливье', description: '200 гр — говядина, картофель, огурцы маринованные, зелёный горошек, яйцо, морковь, майонез', price: 500, badge: null, allergens: [] },
  { id: 'sal9', category: 'salads', name: 'Греческий', description: '250 гр — свежие помидоры и огурцы, фетаки, перец болгарский, оливки, маслины, салат романо, айсберг, масло оливковое и лук', price: 540, badge: null, allergens: [] },
  { id: 'sal10', category: 'salads', name: 'Дары моря', description: '250 гр — морской гребешок, мидии, креветки, салат микс, помидоры черри, соус на основе оливкового масла, дижонской горчицы, мёда и лимонного сока', price: 990, badge: null, allergens: [] },

  { id: 'cold1', category: 'coldAppetizers', name: 'Овощное ассорти', description: '250 гр — свежие помидоры, огурцы и болгарский перец', price: 430, badge: null, allergens: [] },
  { id: 'cold2', category: 'coldAppetizers', name: 'Язык говяжий отварной', description: '150/30 гр — с хреном', price: 590, badge: null, allergens: [] },
  { id: 'cold3', category: 'coldAppetizers', name: 'Мясное ассорти', description: '200 гр — говяжий язык, буженина, бастурма, говядина варёно-копченая', price: 740, badge: null, allergens: [] },
  { id: 'cold4', category: 'coldAppetizers', name: 'Рыбное ассорти', description: '150 гр — осетрина горячего и холодного копчения, семга слабосоленая, масляная', price: 1380, badge: null, allergens: [] },
  { id: 'cold5', category: 'coldAppetizers', name: 'Норвежская принцесса', description: '150 гр — слабосоленая семга, сливочное масло, оливки, лимон', price: 1270, badge: null, allergens: [] },
  { id: 'cold6', category: 'coldAppetizers', name: 'Селедочка по-деревенски', description: '150 гр — филе селёдки с отварным картофелем', price: 390, badge: null, allergens: [] },
  { id: 'cold7', category: 'coldAppetizers', name: 'Баклажаны по-арабски', description: '200/20 гр — сыр, чеснок, грецкий орех, майонез, соус гранатовый', price: 500, badge: null, allergens: [] },
  { id: 'cold8', category: 'coldAppetizers', name: 'Грибочки по-селянски', description: '200 гр — маринованные маслята, лисички, опята, масло, лук и зелень', price: 380, badge: null, allergens: [] },
  { id: 'cold9', category: 'coldAppetizers', name: 'Сырная палитра с мёдом', description: '150/50 гр — камамбер, маасдам, дорблю, чеддер, мраморный', price: 700, badge: null, allergens: [] },
  { id: 'cold10', category: 'coldAppetizers', name: 'Домашние соленья', description: '200 гр — огурцы, помидоры, чеснок, перец, капуста', price: 400, badge: null, allergens: [] },
  { id: 'cold11', category: 'coldAppetizers', name: 'Зеленое ассорти', description: '150 гр', price: 350, badge: null, allergens: [] },
  { id: 'cold12', category: 'coldAppetizers', name: 'Оливки и маслины', description: '50 гр', price: 290, badge: null, allergens: [] },
  { id: 'cold13', category: 'coldAppetizers', name: 'Лимон', description: '50 гр', price: 130, badge: null, allergens: [] },
...
function renderMenuItem(item) {
  ...
  const imagePath = `../img/${item.category}/${item.id}.png`;
